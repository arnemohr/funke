...
.infobox { background: #e8f5f2; border-left: 3px solid var(--color-brand); padding: 10px 13px; border-radius: 0 8px 8px 0; font-size: 13px; color: #1a4a40; margin-bottom: 8px; line-height: 1.5; }
