...
3. Du meldest dich an. Du gibst an:
   ...
   - wen du mitbringst (auch mit **Vor- und Nachnamen**) — und **wenn du magst, deren E-Mail-Adresse**. Dann schicken wir dieser Person ihren Eintritts-Code direkt zu, und du musst nichts weiterleiten. Ohne Adresse bleibt alles wie bisher: du bekommst alle Codes.
